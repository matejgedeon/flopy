...
class Mthp(BaseModel):
    """
    MTHP Model Class.

    Parameters
    ----------
    modelname : str, default "mthptest"
    ...
    ftlfree : TYPE, default False
        ...
        (False, default).
    version : str, default "mthp"
        MTHP version. Choose one of: "mthp" (default) or "mt3d-usgs" for control runs.
    exe_name : str, default "HPx_MT3D-USGS"
    ...
    def __init__(
        ...
        # Set attributes
        self.version_types = {"mthp": "MTHP", "mt3d-usgs": "MT3D-USGS"}
        ...
        self.lst = MthpList(self, listunit=listunit)
        ...
        if ftlfilename is None:
            ...
            print("MTHP will not work without a linker file")
        else:
    ...
    def load(
        ...
        ----------
        f : str
            Path to MTHP name file to load.
        version : str, default "mthp"
            Model version. Choose one of: "mthp" (default) or "mt3d-usgs".
        exe_name : str, default "HPx_MT3D-USGS"
            The name of the executable to use.
        verbose : bool, default False
        ...
        modflowmodel : flopy.modflow.mf.Modflow, optional
            This is a flopy Modflow model object upon which this Mthp
            model is based.
        ...
        --------
        >>> import flopy
        >>> mt = flopy.mt3d.mt.Mt3dms.load('example.nam') -- to be changed
        >>> mt.ftlfilename = 'example.ftl'
