...
class MthDsp(Package):
    """
    MTHP Dispersion Package Class.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if unitnumber is None:
            unitnumber = MthDsp._defaultunit()
        elif unitnumber == 0:
            unitnumber = MthDsp._reservedunit()
    ...
    def load(
        ...
        if ext_unit_dict is not None:
            unitnumber, filenames[0] = model.get_ext_dict_attr(
                ext_unit_dict, filetype=MthDsp._ftype()
            )
