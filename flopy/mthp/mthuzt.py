...
class MthUzt(Package):
    """
    MTHP (MT3D-USGS) Unsaturated-Zone Transport package class
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if unitnumber is None:
            unitnumber = MthUzt._defaultunit()
        elif unitnumber == 0:
            unitnumber = MthUzt._reservedunit()
        ...
        self.heading1 = "# UZT for MTHP, generated by Flopy"
        self.icbcuz = icbcuz
        self.iet = iet
    ...
    def load(
        ...
        if ext_unit_dict is not None:
            unitnumber, filenames[0] = model.get_ext_dict_attr(
                ext_unit_dict, filetype=MthUzt._ftype()
            )
            if icbcuz > 0:
